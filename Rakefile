...
VERSION = "0.1"
SRC = %w{core ../lib/js-class/src/class ../lib/js-class/src/property Animate Collision Property Util Draw DisplayObject Clip Emitter Image Range Rect Physics Sprite Spritesheet Text Tween Action outro}
SRCS = SRC.join(' ')
