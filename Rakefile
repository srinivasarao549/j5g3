...
VERSION = "0.1"
SRC = %w{core Class Animate Collision Property Util Draw DisplayObject Clip Emitter Image Input Range Rect Physics Sprite Spritesheet Text Tween Action Map Network outro}
SRCS = SRC.join(' ')
